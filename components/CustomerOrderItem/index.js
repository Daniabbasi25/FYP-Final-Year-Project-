...
const ListofProduct=(props)=>{
  const [isselected,setisselected]=useState(false);
    const {productname,quantitytype,price,quantity,ptotal}=props.cartdata;
...
<CheckBox checked={isselected} onPress={handleisselect}/>
        </Card>
    )
};
const Flist=()=>{
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <View style={styles.iconcontainer}>
           {
            ...
            <TouchableOpacity onPress={()=>props.handledelet(props.cartdata)} style={styles.canclebutton}>
            ...
            {/* <Icon name="delete" size={25} color="red"/> */}<Text style={{color:"#FFF"}}>Recive</Text>
             ...
             <TouchableOpacity onPress={()=>props.handledelet(props.cartdata)} style={styles.Rate}>
